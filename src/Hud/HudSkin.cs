...
namespace PoEHUD.HUD
{
    public static class HUDSkin
    {
        ...
        public static readonly Color FireDamageColor = new ColorBGRA(150, 0, 0, 0xFF);
        public static readonly Color ColdDamageColor = new ColorBGRA(54, 100, 146, 0xFF);
        public static readonly Color LightingDamageColor = new ColorBGRA(255, 215, 0, 0xFF);
        public static readonly Color ChaosDamageColor = new ColorBGRA(208, 31, 144, 0xFF);
    }
}
