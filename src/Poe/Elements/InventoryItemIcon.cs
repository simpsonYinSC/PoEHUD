...
namespace PoeHUD.Poe.Elements
{
    public class InventoryItemIcon : Element
    {
        ...
        public InventoryItemIcon()
        {
            ...
            inventoryItemTooltip = () => ReadObject<Element>(Address + 0xA3C);
            ...
            get
            {
                switch (ToolTipType)
                {
                    case ToolTipType.ItemOnGround:
                        ...
                        ItemsOnGroundLabelElement le = Game.IngameState.IngameUi.ReadObjectAt<ItemsOnGroundLabelElement>(0xA40);
                        if (le == null)
                            return null;
