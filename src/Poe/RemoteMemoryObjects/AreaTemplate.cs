namespace PoEHUD.PoE.RemoteMemoryObjects
{
    ...
    {
        public int Act => Memory.ReadInt(Address + 10);
        public int NominalLevel => Memory.ReadInt(Address + 0x16); // Not sure
        public bool IsTown => Memory.ReadByte(Address + 0x14) == 1;
        public bool HasWaypoint => Memory.ReadByte(Address + 0x15) == 1;
        public string RawName => Memory.ReadStringU(Memory.ReadLong(Address));
        public string Name => Memory.ReadStringU(Memory.ReadLong(Address + 8));
    }
