...
namespace PoeHUD.Poe.RemoteMemoryObjects
{
    public class IngameUIElements : RemoteMemoryObject
    {
        ...
        public Element OpenLeftPanel => ReadObjectAt<Element>(0xA20 + Offsets.GarenaTWDelta);
        public Element OpenRightPanel => ReadObjectAt<Element>(0xA24 + Offsets.GarenaTWDelta);
