...
namespace PoeHUD.Poe.RemoteMemoryObjects
{
    public class IngameUIElements : RemoteMemoryObject
    {
        ...
        */
        public Element QuestTracker => ReadObjectAt<Element>(0x9E4 + Offsets.GarenaTWDelta);
        /*
        Unused
        public Element MtxInventory => ReadObjectAt<Element>(0x100);
        public Element MtxShop => ReadObjectAt<Element>(0x104);
        */
        public Element InventoryPanel => ReadObjectAt<Element>(0xA28 + Offsets.GarenaTWDelta);
        /*
        Unused
        public Element StashPanel => ReadObjectAt<Element>(0x104);
        public Element SocialPanel => ReadObjectAt<Element>(0x118);
        */
        public Element TreePanel => ReadObjectAt<Element>(0xA3C + Offsets.GarenaTWDelta);
        /*
        Unused
        ...
        */
        public Map Map => ReadObjectAt<Map>(0xA54 + Offsets.GarenaTWDelta);
        public IEnumerable<ItemsOnGroundLabelElement> ItemsOnGroundLabels
        {
            get
            {
                var itemsOnGroundLabelRoot = ReadObjectAt<ItemsOnGroundLabelElement>(0xA58 + Offsets.GarenaTWDelta);
        ...
        */
        public Element OpenLeftPanel => ReadObjectAt<Element>(0xA0C + Offsets.GarenaTWDelta);
        public Element OpenRightPanel => ReadObjectAt<Element>(0xA10 + Offsets.GarenaTWDelta);
        /*
        Unused
        ...
        */
        public Element GemLvlUpPanel => ReadObjectAt<Element>(0xB24 + Offsets.GarenaTWDelta);
        public ItemOnGroundTooltip ItemOnGroundTooltip => ReadObjectAt<ItemOnGroundTooltip>(0xB34 + Offsets.GarenaTWDelta);
    }
}